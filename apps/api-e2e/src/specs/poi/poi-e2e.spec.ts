...
describe('POI Orchestration Integration Tests', () => {
  ...
  beforeEach(async () => {
    ...
    //   phone: '(555) 555-5555',
    // });
    const { body: cm } = await axios.post('http://localhost:3335/changeMaker/createProfile', {
      query: cmQuery,
      token: auth.body.token,
      dto: {
        handle: 'bobby',
  ...
  describe('get', () => {
    it('should get zero pois on system init', async () => {
      ...
      const { body } = await axios.post('http://localhost:3335/poi/get', {
        query: poiQuery,
        token: auth.body.token,
      });
    ...
    it('should get pois', async () => {
      ...
      await axios.post('http://localhost:3335/poi/create', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
  ...
  describe('create', () => {
    it('should not create if enrollment status is not enrolled', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/create', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
          enrollmentId: enrollment.id,
    ...
    describe('not create preexisting', () => {
      it('should not create if preexisting created poi already exists', async () => {
        ...
        //   enrollmentId: enrollment.id,
        // });
        const { body: poi } = await axios.post('http://localhost:3335/poi/create', {
          query: poiQuery,
          token: auth.body.token,
          dto: {
            enrollmentId: enrollment.id,
        ...
        //   enrollmentId: enrollment.id,
        // });
        const temp = await axios.post('http://localhost:3335/poi/create', {
          query: poiQuery,
          token: auth.body.token,
          dto: {
            enrollmentId: enrollment.id,
      ...
      it('should not create if preexisting started poi already exists', async () => {
        ...
        //   enrollmentId: enrollment.id,
        // });
        const { body } = await axios.post('http://localhost:3335/poi/create', {
          query: poiQuery,
          token: auth.body.token,
          dto: {
            enrollmentId: enrollment.id,
        ...
        //   enrollmentId: enrollment.id,
        // });
        const result = await axios.post('http://localhost:3335/poi/create', {
          query: poiQuery,
          token: auth.body.token,
          dto: {
            enrollmentId: enrollment.id,
    ...
    describe('create preexisting', () => {
      ...
      it('should create when there is a preexisting submitted poi', async () => {
        ...
        let { body: poi } = await axios.post('http://localhost:3335/poi/create', {
          query: poiQuery,
          token: auth.body.token,
          dto: {
            enrollmentId: enrollment.id,
  ...
  describe('start', () => {
    it('should not start if not in created state', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/start', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
          poiId: poi.id,
    ...
    it('should start if location is not required and no location given', async () => {
      ...
      const { body: res } = await axios.post('http://localhost:3335/poi/start', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
          poiId: poi.id,
  ...
  describe('stop', () => {
    it('should stop if in started state', async () => {
      ...
      const { body: res } = await axios.post('http://localhost:3335/poi/stop', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
          poiId: poi.id,
    ...
    it('should not stop if in created state', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/stop', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
          poiId: poi.id,
  ...
  describe('withdraw', () => {
    it('should withdraw if created', async () => {
      ...
      const { body: res } = await axios.post('http://localhost:3335/poi/withdraw', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
          poiId: poi.id,
    ...
    it('should not withdraw if approved', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/withdraw', {
        query: { deletedId: true },
        token: auth.body.token,
        dto: {
          poiId: poi.id,
  ...
  describe('pause', () => {
    it('should not pause if in created state', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/pause', {
        query: {},
        token: auth.body.token,
        dto: {
          poiId: poi.id,
    ...
    it('should pause if in started state', async () => {
      ...
      const { body } = await axios.post('http://localhost:3335/poi/pause', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
          poiId: poi.id,
  ...
  describe('resume', () => {
    it('should not resume if in created state', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/resume', {
        query: {},
        token: auth.body.token,
        dto: {
          poiId: poi.id,
    ...
    it('should resume if in paused state', async () => {
      ...
      const { body } = await axios.post('http://localhost:3335/poi/resume', {
        query: {},
        token: auth.body.token,
        dto: {
          poiId: poi.id,
  ...
  describe('submit', () => {
    it('should not submit if in created state', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/submit', {
        query: {},
        token: auth.body.token,
        dto: {
          poiId: poi.id,
    ...
    it('should submit if in started state', async () => {
      ...
      const { body } = await axios.post('http://localhost:3335/poi/submit', {
        query: poiQuery,
        token: auth.body.token,
        dto: {
          poiId: poi.id,
    ...
    it('should submit if questions are required and the correct amount is given', async () => {
      ...
      const { body } = await axios.post('http://localhost:3335/poi/submit', {
        query: poiQuery,
        token: auth.body.token,
        dto: { poiId: poi.id, answers: [{ questionId: qId, answer: 'answer' }] },
        files: [],
      });
      expect(calculatePoiStatus(body)).toBe(PoiStatus.submitted);
    });
  ...
  describe('approve', () => {
    it('should not approve if in created state', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/approve', {
        query: {},
        token: poiApproverOrDenyer.body.token,
        dto: { poiId: poi.id },
      });
    ...
    it('should approve if in submitted state', async () => {
      ...
      const { body } = await axios.post('http://localhost:3335/poi/approve', {
        query: poiQuery,
        token: poiApproverOrDenyer.body.token,
        dto: { poiId: poi.id },
      });
  ...
  describe('deny', () => {
    it('should not deny if in created state', async () => {
      ...
      const { error } = await axios.post('http://localhost:3335/poi/deny', {
        query: {},
        token: poiApproverOrDenyer.body.token,
        dto: { poiId: poi.id },
      });
    ...
    it('should deny if in submitted state', async () => {
      ...
      const { body } = await axios.post('http://localhost:3335/poi/deny', {
        query: poiQuery,
        token: poiApproverOrDenyer.body.token,
        dto: { poiId: poi.id },
      });
